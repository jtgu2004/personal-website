          ...
          <div className="flex flex-col-reverse md:flex-row items-center gap-16">
            ...
            <div className="w-full md:w-1/2 text-left animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                 ...
                 <a href="/assets/John Gu - Resume Web.pdf" download className="flex items-center justify-center px-8 py-3 bg-navy-900 text-white rounded-sm text-sm font-bold uppercase tracking-widest hover:bg-gold-500 transition-colors shadow-lg">
